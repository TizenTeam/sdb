...
#ifndef ANDROID_USB_API_SDBWINAPI_H__
#define ANDROID_USB_API_SDBWINAPI_H__
...
*/
typedef struct _SdbEndpointInformation {
...
// the SDBWIN_EXPORTS symbol defined on the command line. this symbol should
// not be defined on any project that uses this DLL. This way any other project
// whose source files include this file see SDBWIN_API functions as being
// imported from a DLL, whereas this DLL sees symbols defined with this macro
// as being exported.
#ifdef SDBWIN_EXPORTS
#define SDBWIN_API EXTERN_C __declspec(dllexport)
#define SDBWIN_API_CLASS     __declspec(dllexport)
#else
#define SDBWIN_API EXTERN_C __declspec(dllimport)
#define SDBWIN_API_CLASS     __declspec(dllimport)
#endif
...
/** \brief Handle to an API object.
  ...
  1. Interface enumerator that provides access to a list of interfaces that
     ...
     has been created. This handle is created in SdbEnumInterfaces routine.
  2. Interface that is the major object this API deals with. In Windows
     ...
     either SdbCreateInterface or SdbCreateInterfaceByName routines.
  3. Endpoint object (also called a pipe) represents an endpoint on interface
     ...
     one of these routines: SdbOpenEndpoint, SdbOpenDefaultBulkReadEndpoint,
     or SdbOpenDefaultBulkWriteEndpoint.
...
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbEnumInterfaces(GUID class_id,
...
/** \brief Gets next interface information
  ...
  @param[in] sdb_handle Handle to interface enumerator object obtained via
         SdbEnumInterfaces call.
...
*/
SDBWIN_API bool __cdecl SdbNextInterface(SDBAPIHANDLE sdb_handle,
                                 SdbInterfaceInfo* info,
                                 unsigned long* size);

/** \brief Resets enumerator so next call to SdbNextInterface will start
  from the beginning.
...
*/
SDBWIN_API bool __cdecl SdbResetInterfaceEnum(SDBAPIHANDLE sdb_handle);
...
/** \brief Creates USB interface object
  ...
  @return Handle to the interface object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbCreateInterfaceByName(const wchar_t* interface_name);
...
/** \brief Creates USB interface object based on vendor, product and
  ...
  device. It uses SdbCreateInterfaceByName to actually do the create.
  @param[in] class_id Device class ID, assigned by the driver.
  ...
  @return Handle to the interface object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbCreateInterface(GUID class_id,
...
/** \brief Gets interface name.
  ...
  @param[in] sdb_interface A handle to interface object created with 
         SdbCreateInterface call.
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetInterfaceName(SDBAPIHANDLE sdb_interface,
                                    void* buffer,
...
/** \brief Gets serial number for interface's device.
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetSerialNumber(SDBAPIHANDLE sdb_interface,
                                   void* buffer,
                                   unsigned long* buffer_char_size,
                                   bool ansi);
...
/** \brief Gets device descriptor for the USB device associated with
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetUsbDeviceDescriptor(SDBAPIHANDLE sdb_interface,
...
/** \brief Gets descriptor for the selected USB device configuration.
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetUsbConfigurationDescriptor(
...
/** \brief Gets descriptor for the given interface.
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetUsbInterfaceDescriptor(SDBAPIHANDLE sdb_interface,
...
/** \brief Gets information about an endpoint on the given interface.
  ...
  @param[in] endpoint_index Zero-based endpoint index. There are two
         ...
         and SDB_QUERY_BULK_READ_ENDPOINT_INDEX that provide information
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetEndpointInformation(SDBAPIHANDLE sdb_interface,
...
/** \brief Gets information about default bulk read endpoint on the given
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetDefaultBulkReadEndpointInformation(
                    SDBAPIHANDLE sdb_interface,
                    SdbEndpointInformation* info);
...
/** \brief Gets information about default bulk write endpoint on the given
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbGetDefaultBulkWriteEndpointInformation(
                    SDBAPIHANDLE sdb_interface,
                    SdbEndpointInformation* info);
...
/** \brief Opens an endpoint on the given interface.
  ...
  @return Handle to the opened endpoint object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbOpenEndpoint(SDBAPIHANDLE sdb_interface,
                                        unsigned char endpoint_index,
...
/** \brief Opens default bulk read endpoint on the given interface.
  ...
  @return Handle to the opened endpoint object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbOpenDefaultBulkReadEndpoint(
                            SDBAPIHANDLE sdb_interface,
                            SdbOpenAccessType access_type,
                            SdbOpenSharingMode sharing_mode);
...
/** \brief Opens default bulk write endpoint on the given interface.
  ...
  @return Handle to the opened endpoint object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbOpenDefaultBulkWriteEndpoint(
                            SDBAPIHANDLE sdb_interface,
                            SdbOpenAccessType access_type,
                            SdbOpenSharingMode sharing_mode);
...
/** \brief Gets handle to interface object for the given endpoint
  ...
  @param[in] sdb_endpoint A handle to opened endpoint object, obtained via one
         of the SdbOpenXxxEndpoint calls.
...
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbGetEndpointInterface(SDBAPIHANDLE sdb_endpoint);
...
/** \brief Gets information about the given endpoint.
  ...
  @return true on success, false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbQueryInformationEndpoint(SDBAPIHANDLE sdb_endpoint,
                                            SdbEndpointInformation* info);
...
/** \brief Asynchronously reads from the given endpoint.
  ...
  @return A handle to IO completion object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbReadEndpointAsync(SDBAPIHANDLE sdb_endpoint,
                                             void* buffer,
...
/** \brief Asynchronously writes to the given endpoint.
  ...
  @return A handle to IO completion object or NULL on failure. If NULL is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API SDBAPIHANDLE __cdecl SdbWriteEndpointAsync(SDBAPIHANDLE sdb_endpoint,
                                              void* buffer,
...
/** \brief Synchronously reads from the given endpoint.
  ...
  @return true on success and false on failure. If false is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbReadEndpointSync(SDBAPIHANDLE sdb_endpoint,
                                    void* buffer,
                                    unsigned long bytes_to_read,
                                    unsigned long* bytes_read,
                                    unsigned long time_out);
...
/** \brief Synchronously writes to the given endpoint.
  ...
  @return true on success and false on failure. If false is
          returned GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbWriteEndpointSync(SDBAPIHANDLE sdb_endpoint,
                                     void* buffer,
                                     unsigned long bytes_to_write,
                                     unsigned long* bytes_written,
                                     unsigned long time_out);
...
/** \brief Gets overlapped I/O result for async I/O performed on the
  ...
  @param[in] sdb_io_completion A handle to an I/O completion object returned
         from SdbRead/WriteAsync routines.
...
*/
SDBWIN_API bool __cdecl SdbGetOvelappedIoResult(SDBAPIHANDLE sdb_io_completion,
...
*/
SDBWIN_API bool __cdecl SdbHasOvelappedIoComplated(SDBAPIHANDLE sdb_io_completion);

/** \brief Closes handle previously opened with one of the API calls

  @param[in] sdb_handle SDB handle previously opened with one of the API calls
  @return true on success or false on failure. If false is returned
          GetLastError() provides extended error information.
*/
SDBWIN_API bool __cdecl SdbCloseHandle(SDBAPIHANDLE sdb_handle);

#endif  // ANDROID_USB_API_SDBWINAPI_H__
