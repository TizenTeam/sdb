...
#ifndef ANDROID_USB_API_SDB_IO_COMPLETION_H__
#define ANDROID_USB_API_SDB_IO_COMPLETION_H__
/** \file
  This file consists of declaration of class SdbIOCompletion that encapsulates
...
/** \brief Encapsulates encapsulates a generic wrapper around OVERLAPPED Win32
  ...
  needed.
*/
class SDBWIN_API_CLASS SdbIOCompletion : public SdbObjectHandle {
 public:
  ...
  */
  SdbIOCompletion(SdbEndpointObject* parent_io_obj,
 ...
 public:
  ...
  /// Gets parent object
  SdbEndpointObject* parent_io_object() const {
    return parent_io_object_;
  }

  /// Gets parent object handle
  SDBAPIHANDLE GetParentObjectHandle() const {
    return (NULL != parent_io_object()) ? parent_io_object()->sdb_handle() :
                                          NULL;
  }

  // This is a helper for extracting object from the SdbObjectHandleMap
  static SdbObjectType Type() {
    return SdbObjectTypeIoCompletion;
  }
 ...
 protected:
  ...
  /// Parent I/O object
  SdbEndpointObject*  parent_io_object_;

  /// Expected number of bytes transferred in thi I/O
  ULONG               expected_transfer_size_;
};

#endif  // ANDROID_USB_API_SDB_IO_COMPLETION_H__
