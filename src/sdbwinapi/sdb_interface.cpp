...
/** \file
  This file consists of implementation of class SdbInterfaceObject that
...
SdbInterfaceObject::SdbInterfaceObject(const wchar_t* interf_name)
    : SdbObjectHandle(SdbObjectTypeInterface),
      interface_name_(interf_name) {
  ATLASSERT(NULL != interf_name);
}

SdbInterfaceObject::~SdbInterfaceObject() {
}

bool SdbInterfaceObject::GetInterfaceName(void* buffer,
...
bool SdbInterfaceObject::GetUsbDeviceDescriptor(USB_DEVICE_DESCRIPTOR* desc) {
  if (!IsOpened()) {
...
bool SdbInterfaceObject::GetUsbConfigurationDescriptor(
...
bool SdbInterfaceObject::GetUsbInterfaceDescriptor(
