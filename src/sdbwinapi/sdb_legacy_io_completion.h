...
#ifndef ANDROID_USB_API_SDB_LEGACY_IO_COMPLETION_H__
#define ANDROID_USB_API_SDB_LEGACY_IO_COMPLETION_H__
/** \file
  This file consists of declaration of class SdbLegacyIOCompletion that
...
*/
class SdbLegacyIOCompletion : public SdbIOCompletion {
 public:
  /** \brief Constructs the object.
    ...
    @param[in] is_write_ctl Flag indicating whether or not this completion
           object is created for SDB_IOCTL_BULK_WRITE I/O.
  */
  SdbLegacyIOCompletion(SdbLegacyEndpointObject* parent_io_obj,
 ...
 public:
  ...
  SdbLegacyEndpointObject* parent_legacy_io_object() const {
    return reinterpret_cast<SdbLegacyEndpointObject*>(parent_io_object());
  }
  ...
  /// Gets address for SDB_IOCTL_BULK_WRITE output buffer.
...
#endif  // ANDROID_USB_API_SDB_LEGACY_IO_COMPLETION_H__
