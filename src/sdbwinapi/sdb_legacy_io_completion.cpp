...
/** \file
  This file consists of implementation of class SdbLegacyIOCompletion that
...
SdbLegacyIOCompletion::SdbLegacyIOCompletion(
    SdbLegacyEndpointObject* parent_io_obj,
