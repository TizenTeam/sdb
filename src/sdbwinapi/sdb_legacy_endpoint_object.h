...
#ifndef ANDROID_USB_API_SDB_LEGACY_ENDPOINT_OBJECT_H__
#define ANDROID_USB_API_SDB_LEGACY_ENDPOINT_OBJECT_H__
/** \file
  This file consists of declaration of class SdbLegacyEndpointObject that
...
/** Encapsulates a handle opened to an endpoint on our device controlled by
  a custom (legacy) USB driver.
*/
class SdbLegacyEndpointObject : public SdbEndpointObject {
 public:
  /** \brief Constructs the object
    ...
    @param[in] endpoint_index Zero-based endpoint index in the interface's
          array of endpoints.
  */
  SdbLegacyEndpointObject(SdbLegacyInterfaceObject* parent_interf,
                          UCHAR endpoint_id,
  ...
  */
  virtual ~SdbLegacyEndpointObject();
  ...
  */
  virtual SDBAPIHANDLE CreateHandle(const wchar_t* item_path,
