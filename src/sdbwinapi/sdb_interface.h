...
#ifndef ANDROID_USB_API_SDB_INTERFACE_H__
#define ANDROID_USB_API_SDB_INTERFACE_H__
/** \file
  This file consists of declaration of class SdbInterfaceObject that
  encapsulates a generic interface on our USB device.
*/

#include "sdb_object_handle.h"

// 'SdbInterfaceObject::interface_name_' : class 'std::basic_string<_E,_Tr,_A>'
// needs to have dll-interface to be used by clients of class
// 'SdbInterfaceObject' We're ok with that, since interface_name_ will not
...
*/
class SDBWIN_API_CLASS SdbInterfaceObject : public SdbObjectHandle {
 public:
  /** \brief Constructs the object.
    
    @param[in] interf_name Name of the interface
  */
  explicit SdbInterfaceObject(const wchar_t* interf_name);
  ...
  */
  virtual SDBAPIHANDLE OpenEndpoint(UCHAR endpoint_index,
                                    ...
                                    SdbOpenSharingMode sharing_mode) = 0;
...
#endif  // ANDROID_USB_API_SDB_INTERFACE_H__
