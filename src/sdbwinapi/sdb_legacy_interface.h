...
#ifndef ANDROID_USB_API_SDB_LEGACY_INTERFACE_H__
#define ANDROID_USB_API_SDB_LEGACY_INTERFACE_H__
/** \file
  This file consists of declaration of class SdbLegacyInterfaceObject
...
/** \brief Encapsulates an interface on our USB device that is accessible
  via custom USB driver.
*/
class SdbLegacyInterfaceObject : public SdbInterfaceObject {
 public:
  /** \brief Constructs the object.

    @param[in] interf_name Name of the interface
  */
  explicit SdbLegacyInterfaceObject(const wchar_t* interf_name);
  ...
  */
  virtual ~SdbLegacyInterfaceObject();
 ...
 protected:
  /** \brief Opens an endpoint on this interface.
    ...
    @return Handle to the opened endpoint object or NULL on failure.
            ...
            about the error that occurred.
  */
  SDBAPIHANDLE OpenEndpoint(const wchar_t* endpoint_name,
                            UCHAR endpoint_id,
...
#endif  // ANDROID_USB_API_SDB_LEGACY_INTERFACE_H__
