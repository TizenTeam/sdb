...
/** \file
  This file consists of implementation of class SdbIOCompletion that
...
SdbIOCompletion::SdbIOCompletion(SdbEndpointObject* parent_io_obj,
                                 ULONG expected_trans_size,
                                 HANDLE event_hndl)
    : SdbObjectHandle(SdbObjectTypeIoCompletion),
...
SdbIOCompletion::~SdbIOCompletion() {
  parent_io_object_->Release();
}

bool SdbIOCompletion::IsCompleted() {
