...
#ifndef ANDROID_USB_API_SDB_INTERFACE_ENUM_H__
#define ANDROID_USB_API_SDB_INTERFACE_ENUM_H__
/** \file
  This file consists of declaration of SdbInterfaceEnumObject class that
...
*/
class SdbInterfaceEnumObject : public SdbObjectHandle {
 public:
  /** \brief Constructs the object.
  */
  SdbInterfaceEnumObject();
  ...
  */
  virtual ~SdbInterfaceEnumObject();
  ...
  */
  bool Next(SdbInterfaceInfo* info, ULONG* size);
  ...
  */
  ...
  static SdbObjectType Type() {
    return SdbObjectTypeInterfaceEnumerator;
  }

 protected:
  /// Array of interfaces enumerated with this object
  SdbEnumInterfaceArray           interfaces_;

  /// Current enumerator
  SdbEnumInterfaceArray::iterator current_interface_;
};

#endif  // ANDROID_USB_API_SDB_INTERFACE_ENUM_H__
